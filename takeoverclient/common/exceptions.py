...
class InstanceNotFound(NotFound):
    message = _("The instance %(instance_id)s in vmware is not found")
...
class InvalidConfigFile(Exception):
    ...
    def __str__(self):
        return 'Invalid config file path: %s' % self.conf_file


class HostFormatInvalid(Exception):
    def __init__(self, msg):
        self.msg = msg

    def __str__(self):
        return "Invalid host format: %s" % self.msg


class AdoptError(HTTPClientError):
    def __init__(self, code, message):
        self.status_code = code
        self.message = message

    def __str__(self):
        return str({'status': self.status_code, 'message': self.message})
...
class RevertException(Exception):
    ...
    def __str__(self):
        return 'RevertException: %s' % self.msg
